...
<div class="c-movie">
  <div class="cont_inner">
    <h2 class="heading is-xlg">矯正を動画で解説</h2>
    <ul class="movie">
      <?php
        $args = array(
            'paged'          => $paged,
...
<div class="c-about-top__block-button lazyloaded"><a class="c-button is-md is-arrow is-primary is-effect" href="/movie/"><span>詳細を見る</span></a></div>
  </div>
</div>
  ...
  <div class="c-news-top__inner  l-container">
    <div class="c-news-top__titles">
      ...
      <div class="c-news-top__button">
        <a class="c-button is-md is-arrow is-primary is-effect" href="<?php echo home_url(); ?>/information/">一覧を見る</a>
      </div>
    </div>
    ...
    <article>
      <section class="panorama">
        ...
        <div class="panorama_photo fadein scrollin">
          ...
          <p class="panorama02"><img src="https://kondo-shika-shinbi.com/wp-content/uploads/2023/04/icon_360.png" alt="360°"></p>
        </div>
      </section>
    </article>
</div>
